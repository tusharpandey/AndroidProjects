...
public class MainCategory_Async extends AsyncTask<String, String, InputStream> {
	String[] data;
	...
	public MainCategory_Async(String[] data, MainCategory context , String whichLanguage) {
	...
	protected void onPreExecute() {
		...
		initProgressDialog(context.getResources().getString(
				R.string.loading_MainCategoryData));
	}
	...
	protected void onPostExecute(InputStream result) {
		...
		try 
		{
			...
			for ( int i = 0 ; i < jsonArray.length() ; i++ )
			{
				...
				dictList_main.put(HTTP_RESPONSE_MainCategory.image, getString(ithJsonObject, HTTP_RESPONSE_MainCategory.image));
