...
public class CartProductDeleteAsync extends BaseAsync_Get
{
	private Logs_ mLogs;
	Cart context ;
	
	public CartProductDeleteAsync(String url, String[] data, Cart context,
			String loadingText) {
		super(url, data, context, loadingText);
		
		this.context = context ;
		
		mLogs = new Logs_("CartProductDelete");
	...
	protected void onPostExecute(InputStream result) {
		...
		try {
			...
			err.printStackTrace();
			mLogs.showTempLog("Error in Parsing Json Data");
			message = "Error in Response";
		}
